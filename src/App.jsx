      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <section className="text-center py-12">
          ...
          <div className="mt-8 flex justify-center gap-3">
            <button onClick={copyAddress} className="inline-flex items-center gap-2 bg-cyan-500 text-slate-900 font-semibold px-5 py-3 rounded-lg shadow hover:scale-[1.01]">
              Copy Contract
            </button>
